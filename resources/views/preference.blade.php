                ...
                <div class="row parent">
                    ...
                    <div class="card card-row card-primary card-tabs col-md-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="btn-group btn-group-toggle col-md-8" data-toggle="buttons">
                                    <label class="btn btn-secondary @if(strtolower($data['donor']->is_donor_biasa) ==
                                                '1') active @endif">
                                        <input type="radio" name="is_donor_biasa" id="is_donor_biasa" autocomplete="off"
                                            value="1" @if(strtolower($data['donor']->is_donor_biasa) ==
                                        '1') checked @endif>
                                        Ya
                                    </label>
                                    <label class="btn btn-secondary @if(strtolower($data['donor']->is_donor_biasa) ==
                            ...
                            <div class="form-group row">
                                ...
                                <div class="btn-group btn-group-toggle col-md-8" data-toggle="buttons">
                                    <label class="btn btn-secondary @if(strtolower($data['donor']->is_donor_plasma) ==
                                                '1') active @endif">
                                        <input type="radio" name="is_donor_plasma" id="is_donor_plasma" autocomplete="off"
                                            value="1" @if(strtolower($data['donor']->is_donor_plasma) ==
                                        '1') checked @endif>
                                        Ya
                                    </label>
                                    <label class="btn btn-secondary @if(strtolower($data['donor']->is_donor_plasma) ==
                        ...
                        <div class="card-footer">
                            <button class="btn btn-primary float-right" url="{{ url('admin/preference/store') }}" id="btn_simpan" onclick="simpan()">Simpan</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $.each(response, function(i, val) {
                $('#location_preference').append('<li>' + val.name + '<span onclick="delLocation(' +
