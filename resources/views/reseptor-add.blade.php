                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="btn-group btn-group-toggle col-md-8" data-toggle="buttons">
                                                ...
                                                <label class="btn btn-secondary ">
                                                    <input type="radio" name="jenis_kelamin" id="jenis_kelamin2"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input name="peruntukan" type="text" id="peruntukan"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <button id="btn_simpan" url="{{ url('admin/reseptor/store') }}"
                                            onclick="simpan()" class="btn btn-primary"> Simpan </button>
                                    </div>
                                </div>
                            </div>
                        </div>
